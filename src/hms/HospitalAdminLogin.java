...
public class HospitalAdminLogin extends javax.swing.JFrame {
    ...
    public HospitalAdminLogin(DoctorDirectory DocDirectory, HospitalDirectory HospDirectory, PatientDirectory PatDirectory, CityDirectory cityDirectory,  CommunityDirectory CommDirectory) {
        initComponents();
    ...
    private void LoginSystemAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginSystemAdminActionPerformed
        ...
        doc.setPassWord(JPassword.getText());
         ...
         if (doc.getUserName().equals("Hospadmin") && doc.getPassWord().equals("abcde")){
           // HospitalDoctorDetailsAdmin HDDA = new HospitalDoctorDetailsAdmin(DocDirectory, HospDirectory, PatDirectory,cityDirectory, CommDirectory );
            HospitaDoctorDetailsAdmin HDDA = new HospitaDoctorDetailsAdmin(DocDirectory, HospDirectory, PatDirectory,cityDirectory, CommDirectory );
            HDDA.setVisible(true);
            this.dispose();
        }
