...
//    }
    ...
    ViewDoctorDetails(DoctorDirectory DocDirectory, HospitalDirectory HospDirectory, PatientDirectory PatDirectory, CityDirectory cityDirectory, CommunityDirectory CommDirectory,  EncounterHistory EncHistory) {
        //throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody 
        initComponents();
        this.DocDirectory = DocDirectory;
   ...
   this.EncHistory = EncHistory;
    ...
    private void jBtnViewDocDetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtnViewDocDetailsMouseClicked
        ...
        JCityDoc.setSelectedItem(String.valueOf(selectedDoc.getCity()));
       ...
       // JJoiningDateDoc.setEnabled(false);
        ...
        JCommunityDoc.setSelectedItem(String.valueOf(selectedDoc.getCity()));
    ...
    private void JBackViewDoctorBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JBackViewDoctorBtnMouseClicked
        // TODO add your handling code here:
        DoctorDetailsAdmin dda1 = new DoctorDetailsAdmin(DocDirectory, HospDirectory, PatDirectory, cityDirectory, CommDirectory, EncHistory);
