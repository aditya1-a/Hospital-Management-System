...
//    }
    ...
    AddDoctorDetails1(DoctorDirectory DocDirectory, HospitalDirectory HospDirectory, PatientDirectory PatDirectory, CityDirectory cityDirectory, CommunityDirectory CommDirectory,EncounterHistory EncHistory) {
...
//    }
    ...
    private void initComponents() {
        ...
        JCityDoc = new javax.swing.JComboBox<>();
        JCommunityDoc = new javax.swing.JComboBox<>();
        ...
        JDepartmentDoc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Neurology", "Orthopadics", "Gynocologist", "Dermatalogy", "Pediatrics", "Surgery", "Urology" }));
        ...
        JCityDoc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Boston", "New Jersey", "Texas", " " }));
        JCityDoc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JCityDocActionPerformed(evt);
            }
        });
        jPanel1.add(JCityDoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 500, 150, 30));

        JCommunityDoc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Jamaica Plain", "Mission Hill", "Riverway", "Roxbury", "Longwood", "Tremont" }));
        JCommunityDoc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JCommunityDocActionPerformed(evt);
            }
        });
        jPanel1.add(JCommunityDoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 160, 140, 30));
    ...
    private void JSaveDocButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JSaveDocButtonMouseClicked
        ...
        String city = JCityDoc.getSelectedItem().toString();
        String community = JCommunityDoc.getSelectedItem().toString();
        ...
        else if (!(Pattern.matches("^[a-zA-Z0-9]+[@]{1}+[a-zA-Z0-9]+[.]{1}+[a-zA-Z0-9]+$", email))) 
{
        ...
        JOptionPane.showMessageDialog(this, "New record added");
            ...
            JCityDoc.setSelectedIndex(0);
            JAddressDoc.setText("");
            JPhoneNoDoc.setText("");
            JPinCode.setText("");
            JEmail.setText("");
            JCountryDoc.setText("");
            JCommunityDoc.setSelectedIndex(0);
    ...
    private void JBackAddDoctorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBackAddDoctorButtonActionPerformed
        ...
        DoctorDetailsAdmin DDA = new DoctorDetailsAdmin(DocDirectory, HospDirectory, PatDirectory,cityDirectory, CommDirectory);
        DDA.setVisible(true); 
    ...
    private javax.swing.JComboBox<String> JCityDoc;
    private javax.swing.JComboBox<String> JCommunityDoc;
