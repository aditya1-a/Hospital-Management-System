...
public class DoctorLogin extends javax.swing.JFrame {
  ...
  CommunityDirectory CommDirectory;
   EncounterHistory EncHistory;
    ...
    public DoctorLogin(DoctorDirectory DocDirectory, HospitalDirectory HospDirectory, PatientDirectory PatDirectory, CityDirectory cityDirectory,  CommunityDirectory CommDirectory,  EncounterHistory EncHistory) {
        initComponents();
    ...
    private void LoginDocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginDocActionPerformed
        ...
        if (doc.getUserName().equals("Doctoradmin") && doc.getPassWord().equals("abcde")){
            Doctors Doc1 = new Doctors(DocDirectory, HospDirectory, PatDirectory, cityDirectory, CommDirectory, EncHistory);
