...
//    }
    ...
    DoctorDetailsAdmin(DoctorDirectory DocDirectory, HospitalDirectory HospDirectory, PatientDirectory PatDirectory, CityDirectory cityDirectory, CommunityDirectory CommDirectory,EncounterHistory EncHistory) {
...
//      
    ...
    private void JViewDocBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JViewDocBtnActionPerformed
        ...
        ViewDoctorDetails Vdd = new ViewDoctorDetails(DocDirectory, HospDirectory, PatDirectory, cityDirectory, CommDirectory  );     //Add doctor needs reference through DoctorDirectory to DocDirectory variable. DoctorDirectory needs to know the referennce in order to save the data for doctor.
        Vdd.setVisible(true);
        this.dispose();
