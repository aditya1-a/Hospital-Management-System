...
//    }
    ...
    SystemAdmin(DoctorDirectory DocDirectory, HospitalDirectory HospDirectory, PatientDirectory PatDirectory, CityDirectory cityDirectory, CommunityDirectory CommDirectory,  EncounterHistory EncHistory) {
        //throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        initComponents();
        this.PatDirectory = PatDirectory;
        this.HospDirectory = HospDirectory;
    ...
    private void JLogOutSystemAdminBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JLogOutSystemAdminBtnMouseClicked
       ...
       JFrame frame = new JFrame("Logout");
        ...
        {
            //System.exit(0);
             SystemAdminLogin SAL2 = new SystemAdminLogin(DocDirectory, HospDirectory, PatDirectory,cityDirectory, CommDirectory,EncHistory);
