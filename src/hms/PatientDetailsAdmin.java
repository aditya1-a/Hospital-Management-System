...
//    }
    ...
    PatientDetailsAdmin(DoctorDirectory DocDirectory, HospitalDirectory HospDirectory, PatientDirectory PatDirectory, CityDirectory cityDirectory, CommunityDirectory CommDirectory, EncounterHistory EncHistory) {
...
//    
    ...
    private void BtnAddPatientDetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnAddPatientDetailsMouseClicked
        // TODO add your handling code here:
        AddPatientDetails APD = new AddPatientDetails(DocDirectory, HospDirectory, PatDirectory, cityDirectory, CommDirectory, EncHistory);
        APD.setVisible(true);
        this.dispose();
    ...
    private void JBackPatientDetailsAdminBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JBackPatientDetailsAdminBtnMouseClicked
        // TODO add your handling code here:
        SystemAdmin SA1 = new SystemAdmin(DocDirectory, HospDirectory, PatDirectory, cityDirectory, CommDirectory, EncHistory);
       SA1.setVisible(true); 
       this.dispose();
    ...
    private void BtnViewPatientDetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnViewPatientDetailsMouseClicked
        // TODO add your handling code here:
        ViewPatientDetails VPD = new ViewPatientDetails(DocDirectory, HospDirectory, PatDirectory, cityDirectory, CommDirectory, EncHistory);
        VPD.setVisible(true);
        this.dispose();
